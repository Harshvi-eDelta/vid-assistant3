...
# Load custom image
image_path = "/Users/edelta076/Desktop/Project_VID_Assistant3/face_images/fimg12.jpg"
...
for (x, y) in ground_truth_landmarks:
    cv2.circle(resized_img, (int(x), int(y)), 2, (0, 0, 255), -1)
...
plt.figure(figsize=(4,4))
plt.imshow(resized_img)
plt.title("Ground Truth (Red) vs Predicted (Green) Landmarks")
plt.axis("off")
plt.show()